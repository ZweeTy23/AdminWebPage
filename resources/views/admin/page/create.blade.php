                        ...
                        <form action="{{route('page.store', null)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-4">
                                <div class="card border-secondary bg-transparent">
                                    <div class="card-body">
                                        <label for="img" class="text-uppercase small text-muted mb-2 fw-bold">Featured Image</label>
                            ...
                            <div class="d-grid gap-2 mt-5">
                                <input type="submit" value="PUBLISH PAGE" class="btn btn-light fw-bold rounded-0 py-3 text-uppercase" style="letter-spacing: 1px;">
                            </div>
