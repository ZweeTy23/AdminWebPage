            ...
            <div class="col-sm-9">
                <div class="card shadow-lg border-0" style="background: #121212; color: #fff;">
                    <div class="card-header border-bottom border-secondary bg-transparent py-3 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge border border-secondary text-secondary">{{ $category->name }}</span>
                    </div>
                    ...
                    <div class="card-body py-5">
                        <form action="{{route('category.update', $category)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-4 border-secondary bg-transparent">
                                <div class="card-body">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="title" class="form-control bg-dark text-light border-secondary" value="{{$category->title}}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="description" class="text-uppercase small text-muted mb-2 fw-bold">Description</label>
                                        <textarea name="description" class="form-control bg-dark text-light border-secondary" rows="3" required>{{$category->description}}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-secondary bg-transparent">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3 p-2 border border-dark bg-black rounded d-inline-block">
                                            <img src="/img/category/{{$category->img}}" class="img-fluid" style="max-height: 150px; opacity: 0.8;">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="name" class="text-uppercase small text-muted mb-2 fw-bold">Name</label>
                                        <input type="text" name="name" class="form-control bg-dark text-light border-secondary" value="{{$category->name}}" maxlength="190">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="position" class="text-uppercase small text-muted mb-2 fw-bold">Position</label>
                                        <input type="number" name="position" class="form-control bg-dark text-light border-secondary" value="{{$category->position}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 mt-5">
                                <input type="submit" value="UPDATE CATEGORY" class="btn btn-light fw-bold rounded-0 py-3 text-uppercase" style="letter-spacing: 1px;">
                            </div>
