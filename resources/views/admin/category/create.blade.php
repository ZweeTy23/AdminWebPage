                    ...
                    <div class="card-body py-5">
                        <form action="{{route('category.store', null)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card mb-4 border-secondary bg-transparent">
                                <div class="card-body">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="title" class="form-control bg-dark text-light border-secondary" placeholder="Enter category title..." required>
                                    </div>

                                    <div class="form-group">
                                        <label for="description" class="text-uppercase small text-muted mb-2 fw-bold">Description</label>
                                        <textarea name="description" class="form-control bg-dark text-light border-secondary" rows="3" placeholder="Short description..." required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="name" class="text-uppercase small text-muted mb-2 fw-bold">Name (Internal)</label>
                                        <input type="text" name="name" class="form-control bg-dark text-light border-secondary" maxlength="190">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label for="position" class="text-uppercase small text-muted mb-2 fw-bold">Order Position</label>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="text-dark"> <!-- Wrapper para que CKEditor se vea bien -->
                            ...
                            <div class="d-grid gap-2 mt-5">
                                <input type="submit" value="SAVE CATEGORY" class="btn btn-light fw-bold rounded-0 py-3 text-uppercase" style="letter-spacing: 1px;">
                            </div>
